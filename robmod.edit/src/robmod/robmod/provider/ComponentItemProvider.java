/**
 */
package robmod.robmod.provider;
...
/**
 * This is the item provider adapter for a {@link robmod.robmod.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RobmodPackage.Literals.COMPONENT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RobmodPackage.Literals.COMPONENT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RobmodPackage.Literals.COMPONENT__COMPOSITION);
			childrenFeatures.add(RobmodPackage.Literals.COMPONENT__HANDLERS);
			childrenFeatures.add(RobmodPackage.Literals.COMPONENT__INPUT_PORTS);
			childrenFeatures.add(RobmodPackage.Literals.COMPONENT__OUTPUT_PORTS);
			childrenFeatures.add(RobmodPackage.Literals.COMPONENT__PROPERTIES);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RobmodPackage.Literals.COMPONENT__COMPOSITION,
				 RobmodFactory.eINSTANCE.createComponent()));

		newChildDescriptors.add
			(createChildParameter
				(RobmodPackage.Literals.COMPONENT__HANDLERS,
				 RobmodFactory.eINSTANCE.createHandler()));

		newChildDescriptors.add
			(createChildParameter
				(RobmodPackage.Literals.COMPONENT__INPUT_PORTS,
				 RobmodFactory.eINSTANCE.createInputPort()));

		newChildDescriptors.add
			(createChildParameter
				(RobmodPackage.Literals.COMPONENT__OUTPUT_PORTS,
				 RobmodFactory.eINSTANCE.createOutputPort()));

		newChildDescriptors.add
			(createChildParameter
				(RobmodPackage.Literals.COMPONENT__PROPERTIES,
				 RobmodFactory.eINSTANCE.createProperty()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return RobmodEditPlugin.INSTANCE;
	}
