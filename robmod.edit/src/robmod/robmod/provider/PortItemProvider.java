...
/**
 * This is the item provider adapter for a {@link robmod.robmod.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 RobmodPackage.Literals.PORT__DATA_TYPE,
				 true,
				 false,
				 false,
	...
	protected void addExternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_external_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_external_feature", "_UI_Port_type"),
				 RobmodPackage.Literals.PORT__EXTERNAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Port)object).getDataType();
