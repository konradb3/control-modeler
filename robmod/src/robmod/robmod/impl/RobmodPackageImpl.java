 ...
 * @generated
 */
public class RobmodPackageImpl extends EPackageImpl implements RobmodPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see robmod.robmod.RobmodPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RobmodPackageImpl() {
		super(eNS_URI, RobmodFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link RobmodPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static RobmodPackage init() {
		if (isInited) return (RobmodPackage)EPackage.Registry.INSTANCE.getEPackage(RobmodPackage.eNS_URI);

		// Obtain or create and register package
		RobmodPackageImpl theRobmodPackage = (RobmodPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof RobmodPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new RobmodPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theRobmodPackage.createPackageContents();

		// Initialize created meta-data
		theRobmodPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theRobmodPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(RobmodPackage.eNS_URI, theRobmodPackage);
		return theRobmodPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getComponent_Composition() {
	 ...
	 * @generated
	 */
	public EReference getComponent_Handlers() {
	 ...
	 * @generated
	 */
	public EAttribute getComponent_ExecutionOrder() {
	 ...
	 * @generated
	 */
	public EReference getHandler_TrigeredBy() {
	 ...
	 * @generated
	 */
	public EReference getInputPort_Propagation() {
	 ...
	 * @generated
	 */
	public EReference getOutputPort_Delegation() {
	 ...
	 * @generated
	 */
	public EAttribute getOutputPort_Description() {
		return (EAttribute)outputPortEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getPort_External() {
	 ...
	 * @generated
	 */
	public EReference getProperty_Propagate() {
	...
	public void createPackageContents() {
		...
		createEReference(componentEClass, COMPONENT__COMPOSITION);
		createEReference(componentEClass, COMPONENT__HANDLERS);
		...
		createEAttribute(componentEClass, COMPONENT__EXECUTION_ORDER);
		...
		createEReference(outputPortEClass, OUTPUT_PORT__DELEGATION);
		createEAttribute(outputPortEClass, OUTPUT_PORT__DESCRIPTION);

		portEClass = createEClass(PORT);
		createEAttribute(portEClass, PORT__DATA_TYPE);
		createEAttribute(portEClass, PORT__EXTERNAL);
	...
	public void initializePackageContents() {
		...
		initEReference(getComponent_Composition(), this.getComponent(), null, "composition", null, 0, -1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getComponent_Type2(), this.getComponentType(), "type2", "", 1, 1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getComponent_ExecutionOrder(), ecorePackage.getEIntegerObject(), "executionOrder", null, 0, 1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getComponent_Period(), ecorePackage.getEDoubleObject(), "period", null, 0, 1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getOutputPort_Connection(), this.getInputPort(), null, "connection", null, 0, -1, OutputPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOutputPort_Delegation(), this.getOutputPort(), null, "delegation", null, 0, -1, OutputPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getOutputPort_Description(), ecorePackage.getEString(), "description", null, 0, 1, OutputPort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(portEClass, Port.class, "Port", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPort_DataType(), ecorePackage.getEString(), "dataType", null, 1, 1, Port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPort_External(), ecorePackage.getEBoolean(), "external", null, 1, 1, Port.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
