 ...
 * @generated
 */
public abstract class RobmodAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = RobmodDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected RobmodAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
