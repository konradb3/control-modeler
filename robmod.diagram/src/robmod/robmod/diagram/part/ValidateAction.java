...
import robmod.robmod.diagram.providers.RobmodMarkerNavigationProvider;
import robmod.robmod.diagram.providers.RobmodValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			if (RobmodDiagramEditorUtil.openDiagram(view.eResource())) {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		RobmodValidationProvider.runWithConstraints(txDomain, new Runnable() {
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			RobmodMarkerNavigationProvider.deleteMarkers(target);
		}
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		RobmodDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new RobmodDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus,
						new HashSet/*[org.eclipse.emf.ecore.EObject]*/(),
						allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = RobmodDiagramEditorUtil.findView(diagramEditPart,
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		RobmodMarkerNavigationProvider.addMarker(target, elementId, location,
	 ...
	 * @generated
	 */
	private static Set/*[org.eclipse.emf.ecore.EObject]*/collectTargetElements(
			IStatus status,
			Set/*[org.eclipse.emf.ecore.EObject]*/targetElementCollector,
