 ...
 * @generated
 */
public class RobmodInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new RobmodNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ComponentEditPart.MODEL_ID));
		RobmodDiagramEditorUtil
