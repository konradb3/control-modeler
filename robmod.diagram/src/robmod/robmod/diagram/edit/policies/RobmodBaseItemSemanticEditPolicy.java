 ...
 * @generated
 */
public class RobmodBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected RobmodBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						RobmodVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = RobmodElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = RobmodDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			RobmodDiagramEditorPlugin.getInstance().setLinkConstraints(
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateHandlerTrigeredBy_4004(Handler source,
				InputPort target) {
			if (source != null) {
				if (source.getTrigeredBy().contains(target)) {
					return false;
				}
			}
		 ...
		 * @generated
		 */
		public boolean canCreateOutputPortConnection_4005(OutputPort source,
				InputPort target) {
			if (source != null) {
			...
			return canExistOutputPortConnection_4005(source, target);
		}

		/**
		 * @generated
		 */
		public boolean canCreateOutputPortDelegation_4006(OutputPort source,
				OutputPort target) {
			if (source != null) {
				if (source.getDelegation().contains(target)) {
					return false;
				}
			}

			return canExistOutputPortDelegation_4006(source, target);
		}

		/**
		 * @generated
		 */
		public boolean canCreateInputPortPropagation_4007(InputPort source,
				InputPort target) {
			if (source != null) {
				if (source.getPropagation().contains(target)) {
					return false;
				}
			}

			return canExistInputPortPropagation_4007(source, target);
		}
		 ...
		 * @generated
		 */
		public boolean canExistOutputPortConnection_4005(OutputPort source,
				InputPort target) {
			try {
				if (target == null) {
					return true;
		 ...
		 * @generated
		 */
		public boolean canExistOutputPortDelegation_4006(OutputPort source,
				OutputPort target) {
			try {
				if (target == null) {
					return true;
		 ...
		 * @generated
		 */
		public boolean canExistInputPortPropagation_4007(InputPort source,
				InputPort target) {
			try {
				if (target == null) {
					return true;
