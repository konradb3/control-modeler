 ...
 * @generated
 */
public class Component4ItemSemanticEditPolicy extends
		RobmodBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Component4ItemSemanticEditPolicy() {
		...
		for (Iterator/*[?]*/nit = view.getChildren().iterator(); nit.hasNext();) {
			...
			case ComponentThreadCompartmentEditPart.VISUAL_ID:
				for (Iterator/*[?]*/cit = node.getChildren().iterator(); cit
					...
					switch (RobmodVisualIDRegistry.getVisualID(cnode)) {
					case Component5EditPart.VISUAL_ID:
						for (Iterator/*[?]*/it = cnode.getTargetEdges()
								.iterator(); it.hasNext();) {
							Edge incomingLink = (Edge) it.next();
							if (RobmodVisualIDRegistry
									.getVisualID(incomingLink) == ComponentBeforeEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
						...
						for (Iterator/*[?]*/it = cnode.getSourceEdges()
								.iterator(); it.hasNext();) {
							Edge outgoingLink = (Edge) it.next();
							if (RobmodVisualIDRegistry
									.getVisualID(outgoingLink) == ComponentBeforeEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
