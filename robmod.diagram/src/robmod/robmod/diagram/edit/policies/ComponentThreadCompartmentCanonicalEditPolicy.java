 ...
 * @generated
 */
public class ComponentThreadCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return RobmodPackage.eINSTANCE.getComponent_Composition();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List/*[robmod.robmod.diagram.part.RobmodNodeDescriptor]*/childDescriptors = RobmodDiagramUpdater
				.getComponentThreadCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Component5EditPart.VISUAL_ID == RobmodVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List/*[robmod.robmod.diagram.part.RobmodNodeDescriptor]*/childDescriptors = RobmodDiagramUpdater
				.getComponentThreadCompartment_7001SemanticChildren((View) getHost()
						.getModel());
