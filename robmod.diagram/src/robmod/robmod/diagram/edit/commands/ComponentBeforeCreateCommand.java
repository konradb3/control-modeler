 ...
 * @generated
 */
public class ComponentBeforeCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ComponentBeforeCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return RobmodBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateComponentBefore_4009(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getBefore().add(getTarget());
		}
