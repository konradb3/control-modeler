 ...
 * @generated
 */
public class Component4CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public Component4CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Component newElement = RobmodFactory.eINSTANCE.createComponent();

		Component owner = (Component) getElementToEdit();
		owner.getComposition().add(newElement);

		ElementInitializers.getInstance().init_Component_3003(newElement);
