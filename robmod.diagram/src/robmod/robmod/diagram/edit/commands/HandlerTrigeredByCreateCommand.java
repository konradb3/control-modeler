 ...
 * @generated
 */
public class HandlerTrigeredByCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public HandlerTrigeredByCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return RobmodBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateHandlerTrigeredBy_4004(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getTrigeredBy().add(getTarget());
		}
