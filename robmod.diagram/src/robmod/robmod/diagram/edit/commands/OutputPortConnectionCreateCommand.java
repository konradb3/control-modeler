 ...
 * @generated
 */
public class OutputPortConnectionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OutputPortConnectionCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return RobmodBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateOutputPortConnection_4005(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getConnection().add(getTarget());
		}
