 ...
 * @generated
 */
public class OutputPortDataType2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OutputPortDataType2EditPart(View view) {
		super(view);
	}
			...
			parser = RobmodParserProvider
					.getParser(
							...
							RobmodVisualIDRegistry
									.getType(robmod.robmod.diagram.edit.parts.OutputPortDataType2EditPart.VISUAL_ID));
		}
		return parser;
	}
