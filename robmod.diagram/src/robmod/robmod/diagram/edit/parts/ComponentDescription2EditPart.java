 ...
 * @generated
 */
public class ComponentDescription2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ComponentDescription2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RobmodParserProvider
					.getParser(
							RobmodElementTypes.Component_2007,
							getParserElement(),
							RobmodVisualIDRegistry
									.getType(robmod.robmod.diagram.edit.parts.ComponentDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
