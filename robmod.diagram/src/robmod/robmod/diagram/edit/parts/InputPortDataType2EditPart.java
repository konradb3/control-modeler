...
import robmod.robmod.diagram.edit.policies.RobmodTextSelectionEditPolicy;
 ...
 * @generated
 */
public class InputPortDataType2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InputPortDataType2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new RobmodTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ComponentEditPart.NodeLabelDragPolicy());
	}
	...
	protected Image getLabelIcon() {
		...
		return RobmodElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RobmodParserProvider
					.getParser(
							RobmodElementTypes.InputPort_3001,
							getParserElement(),
							RobmodVisualIDRegistry
									.getType(robmod.robmod.diagram.edit.parts.InputPortDataType2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					RobmodEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
