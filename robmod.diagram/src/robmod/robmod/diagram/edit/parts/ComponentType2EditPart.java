 ...
 * @generated
 */
public class ComponentType2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ComponentType2EditPart(View view) {
		super(view);
	}
			...
			parser = RobmodParserProvider
					.getParser(
							...
							RobmodVisualIDRegistry
									.getType(robmod.robmod.diagram.edit.parts.ComponentType2EditPart.VISUAL_ID));
		}
		return parser;
	}
