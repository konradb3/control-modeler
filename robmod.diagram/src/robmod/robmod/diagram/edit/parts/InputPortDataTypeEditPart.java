 ...
 * @generated
 */
public class InputPortDataTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InputPortDataTypeEditPart(View view) {
		super(view);
	}
			...
			parser = RobmodParserProvider
					.getParser(
							...
							RobmodVisualIDRegistry
									.getType(robmod.robmod.diagram.edit.parts.InputPortDataTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
