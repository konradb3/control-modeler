...
import robmod.robmod.diagram.edit.policies.Component5CanonicalEditPolicy;
import robmod.robmod.diagram.edit.policies.Component5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Component5EditPart extends AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public Component5EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(
						RobmodVisualIDRegistry.TYPED_INSTANCE));
		super.createDefaultEditPolicies();
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Component5ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Component5CanonicalEditPolicy());
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		...
		FlowLayoutEditPolicy lep = new FlowLayoutEditPolicy() {
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				...
				switch (RobmodVisualIDRegistry.getVisualID(childView)) {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComponentType4EditPart) {
			((ComponentType4EditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureComponentTypeFigure());
			return true;
		}
	...
	protected void handleNotificationEvent(Notification notification) {
		...
		System.out.println("handleNotificationEvent (" + notification + ")");
		if (notification.getNotifier() instanceof Component) {
			if (notification.getFeature() instanceof EAttribute)
				OrderingHelper
						.numberValueChanged((Component) ((Component) notification
	...
	public List/*[org.eclipse.gmf.runtime.emf.type.core.IElementType]*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof robmod.robmod.diagram.edit.parts.Component5EditPart) {
			types.add(RobmodElementTypes.ComponentBefore_4009);
		}
		return types;
	}
	...
	public class ComponentFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureComponentTypeFigure;
		...
		private void createContents() {
			...
			fFigureComponentTypeFigure = new WrappingLabel();
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureComponentTypeFigure() {
			return fFigureComponentTypeFigure;
		}
	...
	static final Font FFIGURECOMPONENTNAMEFIGURE_FONT = new Font(
			Display.getCurrent(), "Ubuntu", 14, SWT.BOLD);

	/**
	 * @generated
	 */
	static final Font FFIGURECOMPONENTTYPEFIGURE_FONT = new Font(
			Display.getCurrent(), "Ubuntu", 9, SWT.NORMAL);
