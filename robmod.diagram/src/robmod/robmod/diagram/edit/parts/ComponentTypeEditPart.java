 ...
 * @generated
 */
public class ComponentTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ComponentTypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RobmodParserProvider
					.getParser(
							RobmodElementTypes.Component_2003,
							getParserElement(),
							RobmodVisualIDRegistry
									.getType(robmod.robmod.diagram.edit.parts.ComponentTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
