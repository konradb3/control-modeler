 ...
 * @generated
 */
public class ComponentDescriptionEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ComponentDescriptionEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RobmodParserProvider
					.getParser(
							RobmodElementTypes.Component_2006,
							getParserElement(),
							RobmodVisualIDRegistry
									.getType(robmod.robmod.diagram.edit.parts.ComponentDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
