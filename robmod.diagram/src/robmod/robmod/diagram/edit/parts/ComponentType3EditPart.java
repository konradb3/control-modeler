 ...
 * @generated
 */
public class ComponentType3EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ComponentType3EditPart(View view) {
		super(view);
	}
			...
			parser = RobmodParserProvider
					.getParser(
							...
							RobmodVisualIDRegistry
									.getType(robmod.robmod.diagram.edit.parts.ComponentType3EditPart.VISUAL_ID));
		}
		return parser;
	}
