 ...
 * @generated
 */
public class OutputPortDataTypeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public OutputPortDataTypeEditPart(View view) {
		super(view);
	}
			...
			parser = RobmodParserProvider
					.getParser(
							...
							RobmodVisualIDRegistry
									.getType(robmod.robmod.diagram.edit.parts.OutputPortDataTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
