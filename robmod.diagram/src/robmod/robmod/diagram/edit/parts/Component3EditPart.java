...
import robmod.robmod.diagram.edit.policies.Component3CanonicalEditPolicy;
import robmod.robmod.diagram.edit.policies.Component3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Component3EditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Component3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComponentDescriptionEditPart) {
			((ComponentDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureComponentNameFigure());
			return true;
		}
		if (childEditPart instanceof ComponentType2EditPart) {
			((ComponentType2EditPart) childEditPart).setLabel(getPrimaryShape()
