...
public class ReplaceNewObjectWithTemplateCommand extends
		AbstractTransactionalCommand {

	private CreateElementRequest request = null;

	public ReplaceNewObjectWithTemplateCommand(
			TransactionalEditingDomain domain, CreateElementRequest request) {
