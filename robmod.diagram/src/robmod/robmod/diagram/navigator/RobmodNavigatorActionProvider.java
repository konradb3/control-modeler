 ...
 * @generated
 */
public class RobmodNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof RobmodNavigatorItem) {
					selectedElement = ((RobmodNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (ComponentEditPart.MODEL_ID
							.equals(RobmodVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, RobmodDiagramEditor.ID);
