 ...
 * @generated
 */
public class RobmodDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public RobmodDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof RobmodDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((RobmodDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new RobmodDomainNavigatorItem((EObject) objects[i],
