 ...
 * @generated
 */
public class RobmodValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = RobmodDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof RobmodDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ComponentEditPart.MODEL_ID.equals(RobmodVisualIDRegistry
						.getModelID(view));
	}
