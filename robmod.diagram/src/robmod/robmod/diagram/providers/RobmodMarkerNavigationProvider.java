 ...
 * @generated
 */
public class RobmodMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = RobmodDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			RobmodDiagramEditorUtil.selectElementsInDiagram(editor,
