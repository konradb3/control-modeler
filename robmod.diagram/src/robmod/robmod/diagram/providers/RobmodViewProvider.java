 ...
 * @generated
 */
public class RobmodViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ComponentEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = RobmodVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = RobmodVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!RobmodElementTypes.isKnownElementType(elementType)
		...
		return OutputPortEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = RobmodVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != RobmodVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(ComponentEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = RobmodVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = RobmodVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case OutputPortEditPart.VISUAL_ID:
			return createOutputPort_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case HandlerEditPart.VISUAL_ID:
			return createHandler_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case Component2EditPart.VISUAL_ID:
		...
		case InputPortEditPart.VISUAL_ID:
			return createInputPort_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case PropertyEditPart.VISUAL_ID:
			return createProperty_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case Component3EditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (RobmodVisualIDRegistry.getVisualID(elementTypeHint)) {
		case HandlerTrigeredByEditPart.VISUAL_ID:
			return createHandlerTrigeredBy_4004(containerView, index,
					persisted, preferencesHint);
		case OutputPortConnectionEditPart.VISUAL_ID:
			return createOutputPortConnection_4005(containerView, index,
					persisted, preferencesHint);
		case OutputPortDelegationEditPart.VISUAL_ID:
			return createOutputPortDelegation_4006(containerView, index,
					persisted, preferencesHint);
		case InputPortPropagationEditPart.VISUAL_ID:
			return createInputPortPropagation_4007(containerView, index,
					persisted, preferencesHint);
		case HandlerGeneratesEditPart.VISUAL_ID:
			return createHandlerGenerates_4008(containerView, index, persisted,
					preferencesHint);
		case ComponentBeforeEditPart.VISUAL_ID:
			return createComponentBefore_4009(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createOutputPort_2001(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createHandler_2002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RobmodVisualIDRegistry.getType(HandlerEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createComponent_2003(EObject domainElement, View containerView,
		...
		Node label5003 = createLabel(node,
				RobmodVisualIDRegistry.getType(ComponentNameEditPart.VISUAL_ID));
		Node label5007 = createLabel(node,
				RobmodVisualIDRegistry.getType(ComponentTypeEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createProperty_2005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(RobmodVisualIDRegistry.getType(PropertyEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5008 = createLabel(node,
				RobmodVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
	...
	public Node createComponent_2006(EObject domainElement, View containerView,
		...
		Node label5010 = createLabel(node,
				RobmodVisualIDRegistry
						.getType(ComponentDescriptionEditPart.VISUAL_ID));
	...
	public Node createInputPort_3001(EObject domainElement, View containerView,
		...
		Node label5005 = createLabel(node,
				RobmodVisualIDRegistry.getType(InputPortNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createHandlerTrigeredBy_4004(View containerView, int index,
		...
		edge.setType(RobmodVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createOutputPortConnection_4005(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createOutputPortDelegation_4006(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createInputPortPropagation_4007(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createHandlerGenerates_4008(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createComponentBefore_4009(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ComponentEditPart.MODEL_ID.equals(RobmodVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", ComponentEditPart.MODEL_ID); //$NON-NLS-1$
